...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='zone_price',
            field=models.CharField(choices=[('5', 'zone_1'), ('3', 'zone_2'), ('1', 'zone_3')], default='zone_1', max_length=255),
        ),
        migrations.AlterField(
            model_name='parking',
            name='street_type',
            field=models.CharField(choices=[('Street', 'ST'), ('AVE', 'Avenue'), ('BLVD', 'Boulevard'), ('RD', 'Road')], default='ST', max_length=4),
        ),
        migrations.AlterField(
            model_name='profile',
            name='balance',
